...
`r shiny::icon('map-signs')` Get started with building a model in this R Markdown document that accompanies [Preprocess your data with recipes](https://www.tidymodels.org/start/recipes) tidymodels start article.
...
Remember the [Build a model](https://www.tidymodels.org/start/models/) article, we did not use a recipe but used a **formula** instead.
